...
// By: ant-design
// See: https://v0.app/icon/ant-design/tik-tok-outlined
// Example: <IconAntDesignTikTokOutlined width="24px" height="24px" style={{color: "#000000"}} />

export const IconAntDesignTikTokOutlined = ({
                                                height = "2em",
                                                fill = "currentColor",
                                                focusable = "false",
                                                ...props
